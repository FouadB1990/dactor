...
<head>
    ...
    <title>  modern </title>
    <link rel="apple-touch-icon" href="{{URL::asset('assets/dashbord/admin/images/ico/apple-icon-120.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{URL::asset('assets/dashbord/admin/images/ico/favicon.ico')}}">
    <link
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/plugins/animate/animate.css')}}">
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/vendors.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/vendors/css/weather-icons/climacons.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/fonts/meteocons/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/vendors/css/charts/morris.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/vendors/css/charts/chartist.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/vendors/css/forms/selects/select2.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{URL::asset('assets/dashbord/admin/vendors/css/charts/chartist-plugin-tooltip.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{URL::asset('assets/dashbord/admin/vendors/css/forms/toggle/bootstrap-switch.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/vendors/css/forms/toggle/switchery.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/core/menu/menu-types/vertical-menu.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/pages/chat-application.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/app.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/custom-rtl.css')}}">
    <!-- END MODERN CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css"
          href="{{URL::asset('assets/dashbord/admin/css-rtl/core/menu/menu-types/vertical-menu.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/core/colors/palette-gradient.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/fonts/simple-line-icons/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/core/colors/palette-gradient.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/pages/timeline.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/vendors/css/cryptocoins/cryptocoins.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/vendors/css/extensions/datedropper.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/vendors/css/extensions/timedropper.min.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/dashbord/admin/css-rtl/style-rtl.css')}}">
    <!-- END Custom CSS-->
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="modern admin logo"
                             src="{{URL::asset('assets/dashbord/admin/images/logo/logo.png')}}">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرحبا
                  ...
                  <img  style="height: 35px;" src="{{URL::asset('assets/dashbord/admin/images/logo/logo.png')}}" alt="avatar"><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{URL::asset('assets/dashbord/admin/images/portrait/small/avatar-s-19.png')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{URL::asset('assets/dashbord/admin/images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{URL::asset('assets/dashbord/admin/images/portrait/small/avatar-s-3.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{URL::asset('assets/dashbord/admin/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
...
<footer class="footer footer-static footer-light navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; <a class="text-bold-800 grey darken-2" href=""
      target="_blank">Fouad Bittar </a>, All rights reserved. </span>
    </p>
</footer>
...
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/vendors.min.js')}}" type="text/javascript"></script>
<!-- BEGIN VENDOR JS-->
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/tables/datatable/datatables.min.js')}}"
        type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"
        type="text/javascript"></script>

<script src="{{URL::asset('assets/dashbord/admin/vendors/js/forms/toggle/bootstrap-switch.min.js')}}"
        type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/forms/toggle/bootstrap-checkbox.min.js')}}"
        type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/forms/toggle/switchery.min.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/js/scripts/forms/switch.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/forms/select/select2.full.min.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/js/scripts/forms/select/form-select2.js')}}" type="text/javascript"></script>

<!-- BEGIN PAGE VENDOR JS-->
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/charts/chart.min.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/charts/echarts/echarts.js')}}" type="text/javascript"></script>

<script src="{{URL::asset('assets/dashbord/admin/vendors/js/extensions/datedropper.min.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/vendors/js/extensions/timedropper.min.js')}}" type="text/javascript"></script>

<script src="{{URL::asset('assets/dashbord/admin/vendors/js/forms/icheck/icheck.min.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/js/scripts/pages/chat-application.js')}}" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN MODERN JS-->
<script src="{{URL::asset('assets/dashbord/admin/js/core/app-menu.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/js/core/app.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/js/scripts/customizer.js')}}" type="text/javascript"></script>
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{URL::asset('assets/dashbord/admin/js/scripts/pages/dashboard-crypto.js')}}" type="text/javascript"></script>


<script src="{{URL::asset('assets/dashbord/admin/js/scripts/tables/datatables/datatable-basic.js')}}"
        type="text/javascript"></script>
<script src="{{URL::asset('assets/dashbord/admin/js/scripts/extensions/date-time-dropper.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->

<script src="{{URL::asset('assets/dashbord/admin/js/scripts/forms/checkbox-radio.js')}}" type="text/javascript"></script>

<script src="{{URL::asset('assets/dashbord/admin/js/scripts/modal/components-modal.js')}}" type="text/javascript"></script>
